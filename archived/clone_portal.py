...
print("----------------------------")
# region: Authenticate
source_password = "an198432"
target_password = "an198432"
source = GIS("https://idt.esri.com/portal", "anieto", source_password)
target = GIS("http://ngse-dev.eastus.cloudapp.azure.com/portal", "anieto", target_password, verify_cert=False)
target_admin_username = 'anieto'
# endregion
...
source_users = source.users.search('!esri_ & !admin & anieto')
...
source_groups = source.groups.search("!owner:esri_* & !Basemaps & Transportation Analysis & Aviation")
